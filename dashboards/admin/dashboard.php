  ...
  <div class="container">
    ...
    <aside class="sidebar">
      ...
      <nav class="nav">
        ...
        <a href="#" class="nav-link" data-page="reports"><i class="fas fa-chart-bar"></i> View Reports</a>
        <a href="#" class="nav-link" data-page="manage-teacher-subjects"><i class="fas fa-calendar-alt"></i> Manage Teacher subjects</a>
        <a href="#" class="nav-link" data-page="manage-schedule"><i class="fas fa-calendar-alt"></i> Manage Schedule</a>
        <a href="#" class="nav-link" data-page="schedule-view"><i class="fas fa-eye"></i> Schedule View</a>
