...
INSERT INTO `assignments` (`id`, `title`, `due_date`, `status`, `is_archived`, `class_name`, `file_url`, `subject`, `teacher_name`, `pdf_path`, `teacher_id`, `description`, `image_url`, `created_at`) VALUES
(1, 'Do 1 Page Handwriting', '2025-07-22', 'Closed', 1, 'Class 1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-19 21:03:19'),
(2, 'Assignment 2', '2025-07-24', 'Open', 0, 'Class 1', 'uploads/assign_687ed4d77d85f3.73285542.pdf', NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-19 21:03:19'),
(3, 'Test Assignment', '2025-07-24', 'Open', 0, 'Class 1', '', NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-19 21:03:19'),
(4, 'Final Defense', '2025-12-05', 'Open', 0, 'Class 1', '', NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-26 17:46:55'),
(5, 'Test Assignment', '2025-12-05', 'Open', 0, '1', '', NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-26 18:58:33');
...
(7, 50, '2025-11-26', 'present'),
(9, 50, '2025-11-27', 'present'),
(11, 50, '2025-11-28', 'absent'),
(12, 50, '2025-11-23', 'present'),
(13, 50, '2025-11-21', 'absent'),
(14, 50, '2025-11-20', 'present'),
(15, 50, '2025-12-22', 'present');
...
(5, 'Final Defense', 'Final defense of 8th sem', 'events/1764333477_0d24e701.png', 8, '2025-12-04', '06:22:00', '18:24:00', 'Colle Seminar Hall', 49, NULL, '2025-11-28 12:37:57', NULL, 1);
...
(1, 3, 50, 'interested', '2025-11-19 06:29:39'),
(2, 3, 51, '', '2025-11-19 06:59:07'),
(3, 4, 51, '', '2025-11-19 06:59:15'),
(4, 4, 50, 'interested', '2025-11-26 11:45:53'),
(5, 5, 50, 'interested', '2025-11-28 12:38:21'),
(6, 5, 51, '', '2025-11-28 12:38:56');
...
INSERT INTO `fee_components` (`id`, `fee_structure_id`, `component_name`, `amount`) VALUES
(10, 4, 'Tuition Fee', 1500.00),
(11, 4, 'Library Fee', 300.00),
(12, 4, 'Lab Fee', 250.00),
(13, 5, 'Tuition Fee', 1600.00),
(14, 5, 'Library Fee', 300.00),
(15, 5, 'Lab Fee', 250.00);
...
INSERT INTO `fee_invoices` (`id`, `student_id`, `fee_structure_id`, `amount_due`, `discount_amount`, `created_at`) VALUES
(1, 34, 1, 2400.00, 0.00, '2025-11-29 07:11:00'),
(2, 50, 4, 2050.00, 0.00, '2025-11-29 07:20:56'),
(3, 55, 4, 2050.00, 0.00, '2025-11-29 07:20:56');
...
INSERT INTO `fee_payments` (`id`, `invoice_id`, `amount`, `payment_date`, `method`, `reference_no`, `receipt_no`, `recorded_by`, `created_at`) VALUES
(1, 1, 2400.00, '2025-11-29', 'Cash', 'TEST-REF-001', 'F2025-0001', 49, '2025-11-29 07:11:00');
...
INSERT INTO `fee_structures` (`id`, `class_name`, `due_month`, `academic_year`, `total_amount`, `status`, `created_by`, `created_at`) VALUES
(4, 1, '2025-11-01', '2025/2026', 2050.00, 'active', 49, '2025-11-29 07:14:03'),
(5, 2, '2025-11-01', '2025/2026', 2150.00, 'active', 49, '2025-11-29 11:06:02');
...
(5, 50, 'Assignment', 'Assignment 1', '40/50', 'A', 'Very Good', '2025-11-26 14:08:38'),
(6, 50, 'Exam', 'First Terminal Examination English', '47/50', 'A+', 'Excellent', '2025-11-26 14:09:17'),
(7, 50, 'Discipline', 'Class Discipline', '48/50', 'A+', 'Excellent', '2025-11-26 14:10:17'),
(8, 50, 'Exam', 'First Term', '45/50', 'A+', 'Excellent', '2025-11-28 12:29:15'),
(9, 55, 'Assignment', 'Assigmnet 1', '45/50', 'A+', 'Excellent', '2025-11-28 12:50:59');
...
--
-- Table structure for table `risk_logistic_coeffs`
--

CREATE TABLE `risk_logistic_coeffs` (
  `id` int(11) NOT NULL,
  `intercept` double NOT NULL,
  `beta_attendance` double NOT NULL,
  `beta_grade_avg` double NOT NULL,
  `beta_discipline` double NOT NULL,
  `beta_assign_comp` double NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `risk_logistic_coeffs`
--

INSERT INTO `risk_logistic_coeffs` (`id`, `intercept`, `beta_attendance`, `beta_grade_avg`, `beta_discipline`, `beta_assign_comp`, `created_at`) VALUES
(1, 5.1234, -0.0456, -0.0321, 0.21, -0.0178, '2025-12-01 08:06:09');

-- --------------------------------------------------------

--
-- Table structure for table `risk_training_data`
--

CREATE TABLE `risk_training_data` (
  `id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  `attendance_pct` decimal(5,2) NOT NULL,
  `grade_avg_pct` decimal(5,2) NOT NULL,
  `discipline_cnt` int(11) NOT NULL,
  `assign_completion_pct` decimal(5,2) NOT NULL,
  `is_at_risk` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `submissions` (`id`, `student_email`, `assignment_id`, `file_url`, `submitted_at`) VALUES
(1, 'student@example.com', 1, NULL, '2025-07-21 15:22:24'),
(2, 'teststudent1@gmail.com', 2, 'uploads/submissions/sub_692996ead91338.72030275.png', '2025-11-28 18:19:50');
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password_hash`, `phone`, `role`, `gender`, `created_at`, `avatar_path`) VALUES
(3, 'Sanit', 'Basnet', 'sanitbasnet.fb27@gmail.com', '$2y$10$3WDXyU2CKDh4jc..ZzTGc.Wtpg4r2SvrAK72gjHPpQveo6o8NDG.G', 'sanitbasnet.fb27@gma', 'Student', 'male', '2025-07-01 17:14:24', NULL),
(5, 'Bigyan', 'Basnet', 'bigyan@gmail.com', '$2y$10$suywxdxCy9ZfEmxgeldNnewzKJmXOIHHtmy25LK4qrKwIWNV5DnEa', 'bigyan@gmail.com', 'Teacher', 'male', '2025-07-08 03:34:00', NULL),
(6, 'Sanit', 'Basnet', 'sanitadmin@gmail.com', '$2y$10$LwEkKbQGj2ooZLdFOoDcW.1del8V3dtZqBrSs6aKomjvYnfZlu5du', '9874561001', 'Admin', 'male', '2025-07-20 14:56:33', NULL),
(7, 'Aashish', 'Satyal', 'aashish@gmail.com', '$2y$10$izm4eeaiCxkuo4/QaVEBD.b28vK7S6AGDQGiT4nVV4Pc0mqmOeGNq', '9856231447', 'Teacher', 'male', '2025-07-20 14:57:47', NULL),
(8, 'Aayush', 'Timalsina', 'aayush@gmail.com', '$2y$10$QNZdUQWwTL/g6axqUVqele.5LdgkmdctXrGx.QejhVs40N4Ce.4OS', '9821256789', 'Teacher', 'male', '2025-07-20 14:58:55', NULL),
(9, 'Amit', 'Rai', 'amit@gmail.com', '$2y$10$Qkl0xmOo1ZzQxWw7NeRFOuhGrWMeHMliLCyqkig72J413iAVbtVAS', '9871236540', 'Teacher', 'male', '2025-07-20 14:59:50', NULL),
(10, 'Avipsa', 'Joshi', 'avipsa@gmail.com', '$2y$10$yCd5mlb3AAeQf4Z3Z.Vw2uUdiQsQc8/Yh7js2zy/Wb5R7ZleXpGq6', '9845633739', 'Teacher', 'female', '2025-07-20 15:02:18', NULL),
(11, 'Bijaya', 'Giri', 'bijaya@gmail.com', '$2y$10$xCzg0dOgxkXmK/iZJtjgk.L0uTVcWCVKlNQbaRLKGnTAxBLiVu4CK', '9874156230', 'Teacher', 'female', '2025-07-20 15:03:43', NULL),
(12, 'Biplov', 'Malla', 'biplov@gmail.com', '$2y$10$bL6djqz.3eALfI4gc.MxluVv2wBvk2fPoPgPhGHi4FKXYr5XtOwX2', '9876543210', 'Teacher', 'male', '2025-07-20 15:05:08', NULL),
(13, 'Dinanath', 'Mukhiya', 'dinanath@gmail.com', '$2y$10$dHj4Z4ga7ZFoCdw1ZAFAUO4aC1/l31wEhT08ctNP0PFdaYj5lF0SK', '9880562144', 'Teacher', 'male', '2025-07-20 15:06:27', NULL),
(14, 'Chandika', 'Wagle', 'chandika@gmail.com', '$2y$10$oVUpkTf/nraqfXzJ.RthUOpc5gSIjwOHJcE6ZjiB7/FPc6jNZIRKm', '9878456312', 'Teacher', 'female', '2025-07-20 15:08:19', NULL),
(15, 'Hasin', 'Maharjan', 'hasin@gmail.com', '$2y$10$v32.Z4LOITVhWpJQZ3erde8EsqEDcSqJ5MiHWAmdfNIf2TsID4Qc.', '9820053221', 'Teacher', 'male', '2025-07-20 15:09:28', NULL),
(33, 'Balaram', 'Basnet', 'balaram@gmail.com', '$2y$10$lfTQJexs9HbZZ1/DWpFYWO2NfF18KcKVHfK5jtnEQQybWbCwgYqnC', '9829895221', 'Parent', 'male', '2025-07-20 17:59:50', NULL),
(34, 'Falano', 'Sharma', 'falano@gmail.com', '$2y$10$wvAJBC8oRWPuxrh2IvSf5egVq/vqJBIOO9WQAIzgY4fcMDnbl8Scy', '9823223323', 'Student', 'male', '2025-07-21 05:19:20', NULL),
(35, 'bigyan', 'basnet', 'bigyan@student.com', '$2y$10$AQaKKd7QM0K1.4FuaUisi.ENHdLWJBS1noczTx2.hpZDnoIH9yita', '9877676765', 'Student', 'male', '2025-07-21 06:51:12', NULL),
(36, 'Falano', 'Student', 'falanostudent@gmail.com', '$2y$10$Wmp9LfLAJTwc4ry9E.1qmOiV4sXafcUxPthKq2/T1xtGammnzfecy', '4526332345', 'Student', 'male', '2025-07-21 08:28:17', NULL),
(39, 'Parent', 'One', 'parentone@gmail.com', '$2y$10$sBkUHB0LLQFnaU6vb6K3Iuk/nkbhJ/.0RuO0BAtWTM8W7Dtk/hIZC', '8767665654', 'Parent', 'male', '2025-07-21 10:06:41', NULL),
(40, 'Teacher', 'One', 'teacherone@gmail.com', '$2y$10$KQ1tYR2E6WxSQyaNVj7Ue.2DpRUyLU1NtxigJ/uTtWqqv3WNDCon2', '7878767676', 'Teacher', 'male', '2025-07-21 10:55:10', NULL),
(41, 'Falano', 'Parent', 'falankoparent@gmail.com', '$2y$10$4LkWGQF7b4/maTePHDf5GOvyRgBhI2XFWuB69FkdmHFEtjQQbTd1m', '9876767687', 'Parent', 'male', '2025-07-21 12:34:02', NULL),
(42, 'Bigyan', 'Basnet', 'bigyanadmin@admin.com', '$2y$10$Z6g6OpND/K6UgsCOJ0sSleVPl63EGt9oeVgocRx7ogx7oFckvHjOO', '9856575777', 'Admin', 'male', '2025-07-21 14:02:17', NULL),
(43, 'No', 'teacher', 'noteacher@noteacher.vom', '$2y$10$92Y.vejwgejXNyVyckuQkOVpCt3G3/ltncOsJzvhEqyjSff3r0gbW', '5674656767', 'Teacher', 'male', '2025-07-22 02:58:32', NULL),
(44, 'Test', 'Student', 'teststudent@gmail.com', '$2y$10$mNnqAD2jesDRrOOtOUWXvOZWU3WOw2fncjUMI0TUUPpTPI/qiM/fe', '9845343343', 'Student', 'male', '2025-11-12 14:39:32', NULL),
(49, 'Main', 'Admin', 'mainadmin@gmail.com', '$2y$10$8D5vKR4x/oYyt7MkK8t2WeznH76SzbdYqiVaaWW2.k/PyyalbVPxW', '9867656565', 'Admin', 'male', '2025-11-14 05:07:49', NULL),
(50, 'teststudent', 'one', 'teststudent1@gmail.com', '$2y$10$8tmXWJyLnm/9HSdbT7q0yuBM1VNWl5JdBoYrUzGQfitKKGXxiHegq', '9855652265', 'Student', 'male', '2025-11-19 05:46:05', NULL),
(51, 'teststudent', 'two', 'teststudent2@gmail.com', '$2y$10$li7D/FOtaXUX3xmHUfyK0upHTDTKKgWe4qNdyZlYpe2Qk90QTIUYm', '9852542256', 'Student', 'male', '2025-11-19 06:38:18', NULL),
(52, 'testteacher', 'one', 'testteacher1@gmail.com', '$2y$10$Zen9Fz8prX7Qc8X5BFshJuLoULygxTNF5Ie23YkLZTQzRwXE1Km8u', '9852142635', 'Teacher', 'female', '2025-11-19 15:20:35', NULL),
(54, 'testparent', 'one', 'testparent1@gmail.com', '$2y$10$ebuODXLmexDyb92AXmIax.NCPwCC/Wa5KUKYlIc2AjxE3EBAfUL6G', '9876634633', 'Parent', 'male', '2025-11-23 05:02:13', NULL),
(55, 'Hasin', 'Student', 'Hasinstudent@gmail.com', '$2y$10$JNLK2kxiCkImxhfHkv4MCeKl1uRP65.1/0Cnuzj5hcpQ4BRZ9YD5e', '9852142635', 'Student', 'male', '2025-11-28 12:48:36', NULL);
...
CREATE TABLE `user_notification_settings` (
  ...
  `email_grades` tinyint(1) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `assignments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_assignments_class_name` (`class_name`),
...
ALTER TABLE `fee_invoices`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_fee_invoices_student` (`student_id`),
  ADD KEY `idx_fee_invoices_structure` (`fee_structure_id`);
...
ALTER TABLE `fee_payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_fee_payments_invoice` (`invoice_id`);
...
ALTER TABLE `fee_structures`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_fee_struct_unique` (`class_name`,`due_month`,`academic_year`);
...
--
-- Indexes for table `risk_logistic_coeffs`
--
ALTER TABLE `risk_logistic_coeffs`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `risk_training_data`
--
ALTER TABLE `risk_training_data`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `submissions`
  ...
  ADD KEY `idx_submissions_student_email` (`student_email`);
...
--
-- AUTO_INCREMENT for table `risk_logistic_coeffs`
--
ALTER TABLE `risk_logistic_coeffs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `risk_training_data`
--
ALTER TABLE `risk_training_data`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `fee_components`
--
ALTER TABLE `fee_components`
  ADD CONSTRAINT `fee_components_ibfk_1` FOREIGN KEY (`fee_structure_id`) REFERENCES `fee_structures` (`id`) ON DELETE CASCADE;
